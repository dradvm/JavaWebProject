...
public interface CateringOrderRepository extends CrudRepository<CateringOrder, Integer> {
    ...
    int countByCustomerEmail_CustomerEmailAndOrderState(String customerEmail, String orderState);

    List<CateringOrder> findAllByCustomerEmail_CustomerEmailAndOrderStateAndCreateDateBetween(String customerEmail, String orderState, LocalDate startDate, LocalDate endDate);
}
